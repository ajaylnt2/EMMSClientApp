...
var loadDisplayGrid = function () {
    $('#idDisplayTable').bootstrapTable({
        ...
        columns: [
                    ...
                    { field: 'WageID', title: 'WAGES ID', align: 'left' },
                    { field: 'WageType', title: 'WAGES Name', align: 'left' },
...
var saveDisplayNames = function () {
    ...
    if ($('#idDisplayName').val().length > 30) {
        alert("Display name should not be more than 30 characters");
        return false;
    }
    $.ajax({
